...
content_type="$(mimetype --brief "$1")" # I guess this not needed

aws s3 cp "$1" s3://$bucket_name/ShareX/ben/"$name" --acl "public-read" --content-type "$content_type" \
    && echo https://s3.eu-central-1.amazonaws.com/$bucket_name/ShareX/ben/"$name"
